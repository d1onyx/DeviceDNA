...
class AndroidSettingsStore(private val context: Context) : SettingsStore {
    ...
    override suspend fun setMaskSensitive(value: Boolean) {
    ...
    override suspend fun setFastRefresh(value: Boolean) {
        context.settingsDataStore.edit { it[FAST_REFRESH] = value }
    }

    override suspend fun setTemperatureUnit(value: TemperatureUnit) {
        context.settingsDataStore.edit { it[TEMPERATURE_UNIT] = value.name }
    }

    override suspend fun setDataUnit(value: DataUnit) {
    ...
    override suspend fun setPublicIpEnabled(value: Boolean) {
        context.settingsDataStore.edit { it[PUBLIC_IP_ENABLED] = value }
    }

    override suspend fun setShowImei(value: Boolean) {
        context.settingsDataStore.edit { it[SHOW_IMEI] = value }
    }

    override suspend fun setBackgroundMonitoring(value: Boolean) {
    ...
    override suspend fun setExportFormat(value: ExportFormat) {
        context.settingsDataStore.edit { it[EXPORT_FORMAT] = value.name }
    }

    override suspend fun setWidgetsPromoShown(value: Boolean) {
        context.settingsDataStore.edit { it[WIDGETS_PROMO_SHOWN] = value }
    }

    override suspend fun setSmartAlertsEnabled(value: Boolean) {
